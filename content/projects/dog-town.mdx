...
description: "A self-hosted website powered by a Raspberry Pi."
category: "Web App"
skills:
  - "Next.js"
  - "React"
  ...
  - "Node.js"
  - "Python"
image: "/work/images/dog-town/dog-town-screenshot.png"
links:
  - text: "LinkedIn"
...
Over the holidays, my sister gifted me a **Raspberry Pi**. Thanks, sis! 🫶

If you're unfamiliar, a Raspberry Pi is a credit-card-sized computer. Unlike traditional machines, it doesn't include a screen, keyboard, or even a case—just the bare essentials. The main selling point of my model? **It has a power button** 🤯🤯🤯
...
Any computer can be a server—even yours! All it takes is downloading some (free) server software like nginx or Apache and turning it on.

To expose it to the internet, you'd need to configure your router or use a service like Cloudflare Tunnels, like I did. But be careful—if you make a mistake, you might expose your machine in unsafe ways.
