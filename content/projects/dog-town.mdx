...
This is a hobby project of mine, a self-hosted photo-sharing web app running on my Raspberry Pi. Naturally, the theme is **dog photos** because dogs are awesome. 🐶
