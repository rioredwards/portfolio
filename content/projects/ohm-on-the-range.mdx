  ...
  data={{
    ...
    rows: [
      [
        ...
        "SSR, optimized images with mobile/desktop crops, progressive enhancement, perfect Lighthouse scores across every route.",
      ],
      [
...
I added a geometric particle background (particles.js) as _progressive enhancement_. It loads after first paint, so the actual content is always there first. The particles are just atmosphere; if they don't load, nothing breaks.
...
First month after launch: **3,000+ unique visitors**, more than double the previous year's traffic. Lighthouse scores are perfect across every route, which matters when half your audience is on a phone with spotty festival-area cell service.

<LightboxImage
  src={ImgOhmLighthouseScores}
  alt="Lighthouse scores for the Ohm on the Range site"
  caption="Performance as a feature (perfect Lighthouse scores across every route)"
/>
