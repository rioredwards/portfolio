...
title: "j-scribe"
slug: "j-scribe"
description: "j-scribe is a versatile platform to create, share, and modify code snippets. With support for various libraries and frameworks, j-scribe's intuitive user interface and live preview make it easy to see the results of your code as you type."
category: "Web App"
skills:
  - "TypeScript"
  - "JavaScript"
  ...
  - "Lerna"
  - "esbuild"
image: "/work/images/j-scribe-preview.webp"
links:
  - text: "Try"
    url: "https://j-scribe.vercel.app/"
  - text: "GitHub"
    url: "https://github.com/rioredwards/j-scribe"
order: 2
---

_Your All-in-One JavaScript_ _**Sandbox**_ _and_ _**Notebook**_ _._

<LightboxImage src={ImgJScribePreview} alt="j-scribe Header" />
...
<LightboxImage src={ImgJScribePreview} alt="j-scribe preview" />
