...
slug: "error-affirmations"
description: "Receive all your favorite Error Affirmations, when you need them most! With an easy install and a variety of options for customization, our Jest Reporter is sure to help soften the blow from any failing tests and give you the confidence to carry on!"
category: "Package"
skills:
  - "JavaScript"
  - "Node.js"
image: "/work/images/error-affirmations-preview.webp"
links:
  - text: "npm"
    url: "https://www.npmjs.com/package/error-affirmations"
  - text: "GitHub"
    url: "https://github.com/VSCode-Empaths/VSCode-Affirmations-Jest-Reporter"
order: 3
---

_"You are_ **_not_** _defined by your code"_

![Error Affirmations Jest Reporter Header](/work/images/error_affirmations_jest_reporter_header.png)
...
![Error-Affirmations-Preview](/work/images/error-affirmations-preview.gif)
...
![Error Affirmations Jest Reporter Screenshot 1](/work/images/error_affirmations_jest_reporter_screenshot_1.png)
...
![Error Affirmations Info Window Screenshot](/work/images/error_affirmations_info_window_screenshot.png)
...
![Error Affirmations VSCode Extension Preview](/work/images/error_affirmations_vscode_extension_preview.png)

### Website

[Try](https://error-affirmations.netlify.app/) - [GitHub](https://github.com/VSCode-Empaths/VSCode-Affirmations-Web-Frontend)

![Error Affirmations Website Preview](/work/images/error_affirmations_website_preview.png)
