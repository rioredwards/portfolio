      ...
      <nav className="bg-sidebar/80 flex flex-col gap-1 rounded-(--border-radius) p-(--padding) backdrop-blur-sm transition-all duration-300 [--border-radius:var(--radius-3xl)] [--padding:calc(var(--spacing)*2)]">
        {socialLinks.map((link, index) => (
          <Link
            ...
            className="group/item text-sidebar-foreground ring-ring/50 hover:bg-background/50 hover:text-sidebar-primary flex items-center gap-0 rounded-[calc(var(--border-radius)-var(--padding))] px-2 py-2 transition-all duration-300 group-hover:gap-3 group-hover:px-3"
