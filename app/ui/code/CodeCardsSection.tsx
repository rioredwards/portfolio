...
const CodeCardsSection = async () => {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-[448px] sm:max-w-[720px] md:max-w-[900px] lg:max-w-[1200px] xl:max-w-[1300px] 2xl:max-w-[1500px] px-8 sm:px-12 md:px-16 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 justify-center items-center justify-items-center content-center">
