...
export const CodeCardPreview: ForwardRefRenderFunction<HTMLDivElement, CodeCardType['preview']> = (
  props,
  ref
) => {
...
const RefCodeCardPreview = forwardRef<HTMLDivElement, CodeCardType['preview']>(CodeCardPreview);
